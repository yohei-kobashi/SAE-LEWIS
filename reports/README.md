...
> 0.142/0.140・床0.000/0.014)/ **Ours-AD** = Ours-ZSからの防御付き
> 適応FT(p100 s8000で凍結・07-25、**0.477/0.349・床0.002/0.002、
> E_enh 0.544・統合FIC 0.626=全指標で全腕最良**。04§10.7)。
> BLEND(α)・v3d系はラダー=付録行に降格。
...
- **v6切り分け完了(07-23、04§9o)**: **T3のみ=新最良(abl 0.150/enh
  ...
  T3スクラッチ+⑦文脈内spec
- **🏁 最終構成(07-25凍結)**: **主行=Ours-ZS(0.142/0.140、床
  0.000/0.014)/適応行=Ours-AD=防御付き適応FT p100 s8000**
  (exact **0.477/0.349**・床0.002/0.002、E_enh 0.544/E_abl 0.987/
  統合FIC **0.626**=89feat、全指標で全腕・全構成最良)。s10000延長は
  dev峰未更新で**STOP8000**(dev: s8000 0.4250 > s8500-9500 0.355-0.365、
  s10000 0.410)。L4/L20の適応行はblendのまま(参考行)。
  **測定キャンペーン完了 — 論文数値は04§10で確定**
