...
- **v6切り分け完了(07-23、04§9o)**: **T3のみ=新最良(abl 0.150/enh
  ...
  T3スクラッチ+⑦文脈内spec
- **🏁 最終構成(07-24夜ユーザー更新)**: **主行=Ours-ZS(zero-shot、
  床0.000/0.014)/適応行(暫定)=mixft p50 s2000**(混合FT: T4系50%+
  破損リプレイ50%・LR1e-4・スクランブル行、exact **0.235/0.146**・
  床0.006/0.026、E_enh 0.319/E_abl 0.938)。代替点: 同ランs3500=
  厳格床(.000/.010)で0.212/0.142。blend(E_enh 0.370)はフロンティア
  参考。比率ablation(p0/25/50/75/100@s2000固定)実行中。
