...
# p100 anchor under SERIES conditions (user 2026-07-24): the ratio
# ablation endpoint — t4v2 cache alone (scramble nulls included, NO
# corruption replay), LR 1e-4, 4k steps, E' selection. Completes the
# confound-free curve p in {0(ZS),25,50,75,100}; T4v1 stays a separate
# reference (no defenses, LR 3e-4, dev-NLL selection).
# Run inside interact-g: bash run_mixft4.sh
...
print(f"# FULL ratio x step dev table (ZS ref {ref:.4f}/{refr:.4f}):")
for pm in ("p25", "p50", "p75", "p100"):
