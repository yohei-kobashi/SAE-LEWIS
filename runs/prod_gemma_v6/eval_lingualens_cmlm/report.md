...
intervention: diff-based, scope=local blocklist=yes steer_lambda=1 fill_iterative=8 k_amp=64 k_sup=64 pool_topk=64; l_max=3 ins_threshold=0.9; refine_passes=3 (recompute)

| condition | exact_match | copy_rate | sim_target | sim_source | edit_loc_iou | sae_shift | bleu | chrf |
|---|---|---|---|---|---|---|---|---|
| true | 0.1140 | 0.6040 | 0.6676 | 0.8751 | 0.3118 | 0.0001 | — | — |
